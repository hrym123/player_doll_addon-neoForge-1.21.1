...
public abstract class BaseDollRenderer<T extends BaseDollEntity> extends EntityRenderer<T> {
    ...
    protected ResourceLocation getSkinLocation(T entity) {
        ...
        try {
            ...
            // 获取DATA_SKIN_PATH的值
            java.lang.reflect.Field dataSkinPathField = com.lanye.dolladdon.base.entity.BaseDollEntity.class.getDeclaredField("DATA_SKIN_PATH");
