...
public class ModuleLogger {
    ...
    // ==================== 向后兼容的简化方法 ====================
    // 这些方法用于快速迁移，但建议使用上面的模块化方法
    
    /**
     * 记录信息级别日志（简化方法，使用默认模块）
     * @deprecated 建议使用 ModuleLogger.info(moduleName, message, args) 方法
     */
    @Deprecated
    ...
    /**
     * 记录调试级别日志（简化方法，使用默认模块）
     * @deprecated 建议使用 ModuleLogger.debug(moduleName, message, args) 方法
     */
    @Deprecated
    ...
    /**
     * 记录警告级别日志（简化方法，使用默认模块）
     * @deprecated 建议使用 ModuleLogger.warn(moduleName, message, args) 方法
     */
    @Deprecated
    ...
    /**
     * 记录错误级别日志（简化方法，使用默认模块）
     * @deprecated 建议使用 ModuleLogger.error(moduleName, message, args) 方法
     */
    @Deprecated
    ...
    /**
     * 记录错误级别日志（简化方法，使用默认模块）
     * @deprecated 建议使用 ModuleLogger.error(moduleName, message, throwable) 方法
     */
    @Deprecated
